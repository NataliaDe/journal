...
if (isset($time_character) && !empty($time_character)) {
    ...
    $is_not_measures = $time_character['is_not_measures'];
} else {
    $time_loc = NULL;
    $time_likv = NULL;
}
                ...
                <div class="col-lg-2">
                    ...
                    <div class="form-group">
                        <div class="checkbox checkbox-warning">
                            <input id="is_not_measures" type="checkbox" name="is_not_measures" value="1" <?= (isset($is_not_measures) && $is_not_measures == 1) ? 'checked' : '' ?> >
                            <label for="is_not_measures">
                                Меры не принимались
                            </label>
                        </div>
                    </div>
