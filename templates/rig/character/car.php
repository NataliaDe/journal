            ...
            <div class="input-group date" id="time_exit<?= $i ?>">
                   <?php
                              if (isset($row['time_exit'] ) && $row['time_exit']  != '0000-00-00 00:00:00' && $row['time_exit'] !=NULL) {
                                  ?>
                <input type="text" class="form-control datetime"  name="sily[<?= $row['id_sily'] ?>][time_exit]" value="<?= date('Y-m-d H:i', strtotime($row['time_exit'])) ?>" >

                        <?php
                              }
                              else{
                                  ?>
                <input type="text" class="form-control datetime"   name="sily[<?= $row['id_sily'] ?>][time_exit]"   />
                        <?php
                              }
                        ?>
    ...
    <div class="col-lg-2">
        <div class="form-group">
          ...
          //  }
           // else{
                ?>
              <input type="text" class="form-control distance-sily"   name="sily[<?= $row['id_sily'] ?>][distance]"  placeholder="км"  value="<?= $row['distance']  ?>">
            <?php
           // }
            ?>
