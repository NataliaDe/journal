...
<div class="box-body">
    ...
    <form  role="form" id="infoForm" method="POST" action="<?= $baseUrl ?>/rig/<?= $id_rig ?>/info">
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="form-group">
                    <button type="button"  id="collapseButtonReport" class="btn btn-info informing_select" name="send" data-toggle="collapse" data-target="#collapse2"><i class="fa fa-plus" aria-hidden="true"></i> Добавить адресатов</span></button>
                </div>
            </div>
