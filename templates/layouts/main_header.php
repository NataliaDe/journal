...
<!--          <span class="logo-mini">Журнал</span>-->
        ...
        <span class="logo-lg"><b>Журнал </b>ЦОУ <span style="font-size: 14px">1.2</span></span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <span class="logo-lg" style="display: block "><b>Журнал </b>ЦОУ <span style="font-size: 14px">1.2</span></span>
    </a>
...
<!--                <li class="dropdown tasks-menu">
                ...
                <!-- news-->
                <li class="dropdown tasks-menu">
                    <a  href="<?= $baseUrl ?>/news" target="_blank" class="item-menu"><span>Новости <span style="color: cyan">14.11.2018</span></span></a>
                </li>
