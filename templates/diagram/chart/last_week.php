...
#chart, #chartData {
  border: 1px solid #333;
  background: #ebedf2 url("<?= $baseUrl ?>/templates/diagram/chart/images/gradient.png") repeat-x 0 0;
}
...
//echo $monday;
//$monday_prev = date( 'Y-m-d', strtotime( 'monday next week' ) );
//echo $monday_prev;
//print_r($cnt);
$arr_color=array('#0DA068','#194E9C','#ED9C13','#ED5713','#057249',
    '#5F91DC','#F88E5D','#0b8a91','#c60101','#02cbea');
//'#b2af10','#67910b','#0b911c'
//    '#0b8a91','#c60101','#02cbea','#5da5f8','#5d7cf8',
...
<h3>Топ 10 причин выездов</h3>
  ...
  <table id="chartData">
    ...
    <tr>
      <th>Причина</th><th>Значение</th>
     </tr>

<!--    <tr style="color: #0DA068">
      <td>выезд в соседний гарнизон</td><td>1862</td>
    </tr>

    <tr style="color: #194E9C">
      <td>дежурство</td><td>1316</td>
    </tr>

    <tr style="color: #ED9C13">
      <td>демеркуризация</td><td>7129</td>
    </tr>

    <tr style="color: #ED5713">
      <td>другие загорания</td><td>236</td>
    </tr>

    <tr style="color: #057249">
      <td>занятия</td><td>6122</td>
    </tr>

    <tr style="color: #5F91DC">
      <td>платные услуги</td><td>128</td>
    </tr>

    <tr style="color: #F88E5D">
      <td>пожар</td><td>245</td>
    </tr>-->
     ...
     foreach ($cnt as $row) {
        ...
        ?>
     <tr style="color: <?= $arr_color[$i] ?>; font-size: 15px;">
      <td><?= $row['reasonrig_name'] ?></td><td><?= $row['cnt'] ?></td>
    </tr>
     <?php
         $i++;
     }
...
Наполнение реальными данными будет производиться в мае 2019.
  </div>-->
