                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                var input = '<textarea rows="4" class="tabledit-input ' + settings.inputClass + '"  name="' + settings.columns.editable[i][1] + '"  style="display: none;" disabled>'+ $(this).text() +'</textarea>';
                            }
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        if ($table.find('th.tabledit-toolbar-column').length === 0) {
                            $table.find('tr:eq(0)').append('<th class="tabledit-toolbar-column"></th>');
                           // $table.find('tbody tr:first').append('<th class="tabledit-toolbar-column"></th>');
                        }
                        ...
                        $table.find('tr:gt(1)').append('<td style="white-space: nowrap; width: 1%;">' + toolbar + '</td>');
                    }
                }
            }
        };
