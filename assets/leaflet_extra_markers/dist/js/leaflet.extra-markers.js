...
(function (global, factory) {
    ...
    ExtraMarkers.Icon = L.ExtraMarkers.Icon = L.Icon.extend({
        ...
        _createInner: function() {
            var iconColorStyle = "",iconCarsColorStyle = "",iconNamePaspColorStyle = "", iconNumber = "",iconNumberCars = "",iconNumberNamePasp = "", options = this.options;
            if (options.iconColor) {
                iconColorStyle = "style='color: " + options.iconColor + "' ";
            }


            iconCarsColorStyle = "style='color: black; margin-left:23px;font-weight: bolder;' ";
            iconNamePaspColorStyle = "style='color: black;background-color:#dce9f5; margin-top:0px;font-weight: bolder;' ";
            ...
            if (options.number_cars) {
                iconNumberCars = "number='" + options.number_cars + "' ";
            }


            if (options.name_pasp) {
                iconNumberNamePasp = "number='" + options.name_pasp + "' ";
            }
            ...
            //return "<i " + iconNumber + iconColorStyle + "class='" + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i> </i><i " + iconNumberCars + iconCarsColorStyle + "class='cars_cnt " + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i> <i " + iconNumberNamePasp + iconNamePaspColorStyle + "class='cars_cnt " + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i>";

             if (options.name_pasp) {
                 return "<i " + iconNumberNamePasp + iconNamePaspColorStyle + "class='" + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i> </i><i " + iconNumberCars + iconCarsColorStyle + "class='cars_cnt " + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i>";
             }
             else{
                 return "<i " + iconNumber + iconColorStyle + "class='" + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i> </i><i " + iconNumberCars + iconCarsColorStyle + "class='cars_cnt " + options.extraClasses + " " + options.prefix + " " + options.icon + "'></i>";
             }
